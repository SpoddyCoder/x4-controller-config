...
|-------------------------|-----------------------|-----------------------|-------------------------------------------------------------------------------------------------------------|
| Accelerate              | A                     | A                     | `INPUT_STATE_ACCELERATE`, `INPUT_XBUTTON_A`                                                                 |
| Boost                   | A dp                  | ;                     | `INPUT_STATE_BOOST`                                                                                         |
| Deploy Countermeasures  | X                     | X                     | `INPUT_ACTION_DEPLOY_COUNTERMEASURE`, `INPUT_XBUTTON_X`                                                     |
| Target Hostile          | Y                     | Y                     | `INPUT_ACTION_TARGET_NEXT_ENEMY`, `INPUT_XBUTTON_Y`                                                         |
| Target Object           | Y dp                  | ]                     | `INPUT_ACTION_TARGET_NEXT_TARGET`                                                                           |
| Fire Primary Weapon     | RB                    | RB                    | `INPUT_STATE_FIRE_PRIMARY_WEAPON`, `INPUT_XBUTTON_RIGHT_SHOULDER`                                           |
| Fire Secondary Weapon   | LB                    | LB                    | `INPUT_STATE_FIRE_SECONDARY_WEAPON`, `INPUT_XBUTTON_LEFT_SHOULDER`                                          |
| Switch Ammunition       | Dpad Up               | Dpad Up               | `INPUT_ACTION_CYCLE_NEXT_ACTIVE_WEAPON_AMMO`, `INPUT_XBUTTON_DPAD_UP`                                       |
| Scan                    | Dpad Left             | Dpad Left             | `INPUT_ACTION_SCAN_ACTION`, `INPUT_XBUTTON_DPAD_LEFT`                                                       |
