...
My steam controller layout can be found in the community setups.
...
|---------------------|-------------|--------------|-------------|-------------|-------------|
| A                   |             | CTRL + Ak    | SHIFT + Ak  | 1           |             |
| A dp                | ;           | CTRL + ;     | SHIFT + ;   | NUM 1       |             |
| B                   |             | CTRL + Bk    | SHIFT + Bk  | 2           |             |
| B dp                | '           | CTRL + '     | SHIFT + '   | NUM 2       |             |
| X                   |             |              | SHIFT + Xk  | 3           |             |
| X dp                | [           |              | SHIFT + [   | NUM 3       |             |
| Y                   |             | CTRL + Yk    |             | 4           |             |
| Y dp                | ]           | CTRL + ]     |             | NUM 4       |             |
...
* N -> /
  ...
  * `INPUT_KEYCODE_N_CONTROL` -> `INPUT_KEYCODE_SLASH_CONTROL`
* L -> ,
